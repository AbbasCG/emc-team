...
@section('page-title', 'إنشاء قسم جديد')
@section('page-subtitle', 'أضف قسماً جديداً للمنظومة')
...
<div class="form-page-narrow">
    <form method="POST" action="{{ route('admin.departments.store') }}">
        ...
        <div class="emc-card form-section-card">
            ...
            <div class="form-grid-2" style="margin-bottom:18px;">
                ...
                <div>
                    ...
                    <input type="text" name="name_ar" value="{{ old('name_ar') }}"
                           class="emc-input" placeholder="اسم القسم بالعربية">
                </div>
            </div>
            ...
            <div style="margin-bottom:18px;">
                ...
                <textarea name="description" rows="3"
                          class="emc-input" style="resize:vertical;"
                          placeholder="وصف مختصر لمهام هذا القسم...">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="form-grid-2" style="margin-bottom:18px;">
                <div>
                    ...
                    <div style="display:flex;align-items:center;gap:10px;">
                        <input type="color" name="color" value="{{ old('color', '#2691C2') }}"
        ...
        <div class="form-actions" style="margin-top:20px;">
            <button type="submit" class="btn-primary" style="padding:11px 28px;">إنشاء القسم</button>
